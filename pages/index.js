...
function Home() {
  return (
    <div>
      ...
      <div
        id="main"
        className={`${styles.main} d-flex justify-content-center align-content-center`}
      >
        <div className="main-container d-flex justify-content-center align-content-center flex-column">
          <h1 className="main-title text-center fw-bold text-white mb-5 display-3">
            PLAY TRADITIONAL GAME
          </h1>
          <h3 className="main-text text-center fs-2 text-white px-2 mb-5">
          ...
          <div className="d-flex justify-content-center align-content-center mt-4">
            <Link href="/game-list">
              <a className="text-decoration-none link-dark">
                <button
                  type="button"
                  className={`${styles.button} btn btn-lg text-nowrap`}
                >
        ...
        <div className="features-container">
          <div className="row">
            ...
            <div className="col-sm-8 col-md-6 col-lg-5 col-xl-4">
              <h1 className={`${styles.featurestitle} fs-2 text-white mb-2`}>
                What so special?
              </h1>
              <h3
                className={`${styles.featurestext} text-white mb-5 pb-4 display-2`}
              >
                FEATURES
              </h3>
              <ul className={`${styles.marker} ps-3`}>
                <li className={styles.marker1}>
                  <div className={`${styles.first} pb-5`}>
                    <h2 className="features1 ms-4 fs-3 text-warning mb-4">
                      TRADITIONAL GAMES
                    </h2>
                    <p
                      className={`${styles.firstdetail} features1-detail ms-4`}
                    >
                ...
                <li className={styles.markerelse}>
                  <h2 className="features2 ms-4 fs-3 text-warning mb-5">
                    GAME SUIT
                  </h2>
                </li>
                <li className={styles.markerelse}>
          ...
          <div className="row">
            <div className="col-lg-5 p-5 d-flex flex-column justify-content-center align-content-center">
              <div className={styles.quotesbanner}>
                <h1 className="features-text text-white text-nowrap mb-4 display-2">
                  TOP SCORES
                </h1>
                ...
                <Link href="/profile">
                  <a>
                    <button
                      type="button"
                      className={`${styles.button} btn btn-lg text-black mt-4`}
                    >
            ...
            <div
              className={`${styles.cardcontainer} card-container col-lg-5 offset-lg-1`}
            >
              <div className="row">
      ...
      <div id="news" className={styles.news}>
        <div className="row">
          ...
          <div className="col-lg-6 col-md-10 col-sm-12">
            <h1 className={`${styles.newstitle} fs-2 text-white mb-3`}>
              Want to stay in touch?
            </h1>
            <h3 className={`${styles.newstext} text-white mb-4 display-2`}>
              NEWSTELLER SUBSCRIBE
            </h3>
            <p className={`${styles.newsdesc} text-white mb-5`}>
              ...
              We will send you emails containing information about game. We dont
              spam.
            </p>
            <div className="news-input d-sm-flex flex-row flex-nowrap" readOnly>
              <form className={`${styles.formfloat} form-floating mb-3`}>
                <input
                  type="email"
                  className={`${styles.formcontrol} form-control fs-5 text-warning`}
              ...
              <div className={styles.newsbutton}>
                <button
                  type="button"
                  className={`${styles.button} btn btn-lg ms-sm-3`}
                >
      ...
      <footer className="bg-light text-center text-lg-start">
        <div className="text-center text-white p-3 bg-black">
          © 2022 Copyright &nbsp;
          <a className="text-white" href="https://www.binaracademy.com/">
            Binar Academy
          </a>
        </div>
      </footer>
